...
<body>
  ...
  <div class="p-5 mb-4 text-bg-dark container-fluid">
    <div class="container">
      <h1 class="display-5 fw-bold">Editar Detalle</h1>
    </div>
  </div>
    <div class="container">
      <div class="card">
          ...
          <div class="card-body">
            <form method="POST" class="form-horizontal" action="{{ route( 'detalles.update', ['detalle' => $detalle ->id]) }}">
                @method('put')  
                @csrf
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    @if ($producto->id == $detalle ->product_id)
                        <option selected value="{{ $producto->id }}">{{ $producto->name }}</option>
                    @else
